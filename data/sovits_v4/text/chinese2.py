...
from data.sovits_v4.text.symbols import punctuation
from data.sovits_v4.text.tone_sandhi import ToneSandhi
from data.sovits_v4.text.zh_normalization.text_normlization import TextNormalizer
...
if is_g2pw:
    ...
    from data.sovits_v4.text.g2pw import G2PWPinyin, correct_pronunciation
