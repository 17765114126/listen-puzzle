...
from data.human.webrtc import HumanPlayer
...
def build_nerfreal(sessionid: int) -> BaseReal:
    ...
    if opt.model == 'wav2lip':
        from data.human.lipreal import LipReal
        nerfreal = LipReal(opt, model, avatar)
    elif opt.model == 'musetalk':
        from data.human.musereal import MuseReal
        nerfreal = MuseReal(opt, model, avatar)
    # elif opt.model == 'ernerf':
    #     from nerfreal import NeRFReal
    #     nerfreal = NeRFReal(opt,model,avatar)
    # elif opt.model == 'ultralight':
    #     from data.human.lightreal import LightReal
...
if __name__ == '__main__':
    ...
    # musetalk opt
    parser.add_argument('--avatar_id', type=str, default='wav2lip256_zf', help="define which avatar in data/avatars")
    ...
    if opt.model == 'musetalk':
        from data.human.musereal import MuseReal, load_model, load_avatar, warm_up
        ...
        from data.human.lipreal import LipReal, load_model, load_avatar, warm_up
    ...
    # elif opt.model == 'ultralight':
    #     from data.human.lightreal import LightReal,load_model,load_avatar,warm_up
    #     logger.info(opt)
    #     model = load_model(opt)
    #     avatar = load_avatar(opt.avatar_id)
